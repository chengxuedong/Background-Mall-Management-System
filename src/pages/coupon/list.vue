    ...
    <el-card shadow="never" class="border-0">
        ...
        <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
            <el-table-column label="优惠券名称" width="350px">
                <!-- 从scope里面直接解构出row，就不用scope.row了 -->
            ...
            <el-table-column label="操作" align="center" width="180">
                <template #default="scope">
                    ...
                    <el-popconfirm v-if="scope.row.statusText != '领取中'" title="是否要删除该优惠劵？" confirm-button-text="确认"
                    ...
                    <el-popconfirm v-if="scope.row.statusText=='领取中'" title="是否要让该优惠劵失效？" confirm-button-text="失效"
        ...
        <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
            <el-form :model="form" ref="formRef" label-width="120px" :inline="false">
                <el-form-item label="优惠劵名称" prop="name" style="width: 70%;">
                    <el-input v-model="form.name" placeholder="优惠劵名称"></el-input>
                </el-form-item>
                <el-form-item label="类型" prop="type">
                    <el-radio-group v-model="form.type">
                        <!-- 根据`:label='form.type'`来进行判断显示哪一个radio-->
                        <el-radio :value="0">
                            满减
                        </el-radio>
                        <el-radio :value="1">
                ...
                <el-form-item label="发行量" prop="total">
                    <el-input-number v-model="form.total" placeholder="发行量" :min="0" :max="1000">
                ...
                <el-form-item label="排序" prop="order">
                    <el-input-number v-model="form.order" placeholder="排序" :min="0" :max="1000">
                    </el-input-number>
                </el-form-item>
                <el-form-item label="活动时间" style="width: 70%;">
                ...
                <el-form-item label="描述" prop="desc" style="width: 75%;">
                    <el-input v-model="form.desc" type="textarea" :rows=5 placeholder="描述"></el-input>
                </el-form-item>
            </el-form>
        </FormDrawer>
    </el-card>
